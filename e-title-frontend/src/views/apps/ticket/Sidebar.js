...
import { Mail, Star, Check, Trash, Plus, Circle } from 'react-feather'
          ...
          <div className='todo-app-menu'>
            ...
            <PerfectScrollbar className='sidebar-menu-list' options={{ wheelPropagation: false }}>
              <ListGroup tag='div' className='list-group-filters'>
                ...
                >
                  <Circle className='mr-75' size={18} />
                  <span className='align-middle'>My Tasks</span>
                </ListGroupItem>
                <ListGroupItem
                  tag={Link}
                  to={'/apps/ticket/important'}
