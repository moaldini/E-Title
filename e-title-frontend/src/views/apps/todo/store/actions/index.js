...
export const reOrderTasks = tasks => dispatch => dispatch({ type: 'REORDER_TASKS_TODO', tasks })
...
// ** Select Task
export const selectTask = task => dispatch => dispatch({ type: 'SELECT_TASK_TODO', task })
