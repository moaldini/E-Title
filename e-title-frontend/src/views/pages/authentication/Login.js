...
const Login = props => {
  ...
  const [password, setPassword] = useState('ORGANIZATION')
    ...
    <div className='auth-wrapper auth-v2'>
      <Row className='auth-inner m-0'>
        <Link className='brand-logo' to='/'>
          <h2 className='brand-text text-primary ml-1'>Electronic Titles (ET)</h2>
        </Link>
        ...
        <Col className='d-flex align-items-center auth-bg px-2 p-lg-5' lg='4' sm='12'>
          <Col className='px-xl-2 mx-auto' sm='8' md='6' lg='12'>
            <CardTitle tag='h2' className='font-weight-bold mb-1'>Login</CardTitle>
            <CardText className='mb-2 hidden'>Please sign-in to your account.</CardText>
            <Alert color='primary'>
              ...
              <HelpCircle
                id='login-tip'
                className='position-absolute hidden'
                size={18}
            ...
            <div className='divider my-2 hidden'>
              <div className='divider-text'>or</div>
            </div>
            <div className='auth-footer-btn d-flex justify-content-center hidden'>
